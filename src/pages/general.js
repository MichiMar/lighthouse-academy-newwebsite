      ...
      <div className="content-page-wrapper">
        ...
        <div className="text-content">
          <p>
            ...
            Thomas Edison, Anne Frank, Henry Ford, Mahatma Gandhi and the
            founders of Google Larry Page and Sergey Bring and Amazon have in
            common? A Montessori-style early childhood education.
          </p>
          <p>
          ...
          <p>
            It is adaptable and proven. In other words, instead of trying to fit
            a circle in a square hole with a rigid curriculum, we provide a
