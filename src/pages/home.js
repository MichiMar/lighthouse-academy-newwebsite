                      ...
                      <div className="topic-introduction">
                        ...
                        <div className="p2">
                          <h6>
                            ...
                            first years of life, and therefore it is then that
                      ...
                      <div className="topic-introduction">
                        <div className="p1">
                          <h4>
                            ...
                            botany, dance, music and art. We put the world at
                        ...
                        <div className="p2">
                          <h5>
                            ...
                            revives the vigor of a starving man. We observe that
                            a child occupied with matters that awaken his
                            interest seems to blossom, to expand, evincing
                            undreamed of character traits; his abilities give
                            him great satisfaction, and he smiles with a sweet
                            and joyous smile." (San Remo Lectures, p. 28)
                          </h5>
                        </div>
                      </div>
                      ...
                      <div className="topic-introduction">
                        <div className="p1">
                          <h5>
                            ...
                            understand others, collaborate, and seek after
                            peace.
                          </h5>
                        </div>
                        <div className="p2">
                          <h6>
                            ...
                            encouraged by the pleasant and interesting
                            activities in which he has been engaged, is a child
                            filled with health and joy and remarkable for his
                            calmness and discipline." (Dr. Maria Montessori,
                  ...
                  <div className="topic-block">
                    <div>
                      ...
                      <div className="topic-introduction">
                        <div className="p1">
                          <h5>
                            Language used to connect and belong through
                            listening, speaking, reading and writing in Spanish
                            and English. We are a real Spanish immersion
                            program.
                          </h5>
                        </div>
                        <div className="p2">
                          <h6>
                            ...
                            child. We give all possible material, that nothing
                            may lack to the growing soul, and then we watch for
                            the perfect faculty to come, safeguarding the child
                            from interruption so that it may carry its efforts
                  ...
                  <div className="topic-block">
                    <div>
                      ...
                      <div className="topic-introduction">
                        ...
                        <div className="p2">
                          <h5>
                            “If education is always to be conceived along the
                            same antiquated lines of a mere transmission of
                            knowledge, there is little to be hoped from it in
                            the bettering of man's future.”
                          </h5>
                        </div>
                      </div>
                      <div className="image">
